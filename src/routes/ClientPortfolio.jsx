            ...
            <div className='w-full'>
                <ul className='flex border-b-2 text-sm mt-2'>
                    <Link className='' to={"viewClient"}>
                        ...
                        <li  className={`bg-white p-2 items-center mx-1 cursor-pointer ${path == "viewClient" || path == "" ? " border-logeRed border-b-2" : ""} rounded-t-md rounded-b-[-10] px-4 flex`}>
                            <img src='../icons/List.svg' className='h-4 mr-1' /> View Client
                        </li>
                    </Link>
                    <Link className='' to={"addClient"}>
                        ...
                        <li  className={`bg-white p-2  mx-1 cursor-pointer ${path == "addClient" ? "border-logeRed border-b-2" : ""} rounded-t-md rounded-b-[-10] px-4 flex items-center`}><img src='../icons/AddList.svg' className='h-5 mr-1' /> Add Client</li>
                    </Link>
                    ...
                    <li className={`bg-white p-2  mx-1 cursor-pointer ${path == "mapClient" ? "border-logeRed border-b-2" : ""} rounded-t-md rounded-b-[-10] px-4 flex items-center`}> <img src='../icons/AddClients.svg' className='h-[16px] mr-1' /> Map Client</li>
                    </Link>
                </ul>
            </div>
            <div className='w-full'>
